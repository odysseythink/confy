...
func (v *Confy) AddRemoteProvider(provider, endpoint, path string) error {
...
func (v *Confy) AddSecureRemoteProvider(provider, endpoint, path, secretkeyring string) error {
	if !slices.Contains(SupportedRemoteProviders, provider) {
		return UnsupportedRemoteProviderError(provider)
	}
	if provider != "" && endpoint != "" {
...
func (v *Confy) providerPathExists(p *defaultRemoteProvider) bool {
...
func (v *Confy) ReadRemoteConfig() error {
	return v.getKeyValueConfig()
}

func WatchRemoteConfig() error { return v.WatchRemoteConfig() }
func (v *Confy) WatchRemoteConfig() error {
	return v.watchKeyValueConfig()
}

func (v *Confy) WatchRemoteConfigOnChannel() error {
...
func (v *Confy) getRemoteConfig(provider RemoteProvider) (map[string]any, error) {
...
func (v *Confy) watchRemoteConfig(provider RemoteProvider) (map[string]any, error) {
